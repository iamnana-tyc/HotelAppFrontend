...
moduleForAcceptance('[AGAT] Acceptance | i i s product 18021 client l');

test('testing i-i-s-product-18021-client-l', function(assert) {
  visit('/i-i-s-product-18021-client-l');
